...
class ToPreparePage extends StatefulWidget {
  final String sellerId;

  const ToPreparePage({super.key, required this.sellerId});

  @override
  State<ToPreparePage> createState() => _ToPreparePageState();
}
            ...
            return RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      'No to prepare products were found',
                      style: TextStyle(
                        fontFamily: "Poppins",
